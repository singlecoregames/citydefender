...
export const TREE: readonly TreeNode[] = [
  ...
  // ── Core-powered nodes (paid in ◆ Cores from bosses) ───────────────────
  {
    ...
    description: '+20% all turret damage',
    branch: 'automation',
    col: -2,
    row: 2,
    maxLevel: 5,
    ...
    currency: 'cores',
    requires: ['turret_gatling'],
    effects: [{ stat: 'turretDamageMul', op: 'mul', value: 0.2 }],
  },
  {
    id: 'cooling_core',
    name: 'Cooling Core',
    description: '+15% all turret fire rate',
    branch: 'automation',
    col: 2,
    row: 2,
    maxLevel: 4,
    ...
    effects: [{ stat: 'turretFireRateMul', op: 'mul', value: 0.15 }],
  },
  {
    id: 'bastion_core',
    name: 'Bastion Core',
