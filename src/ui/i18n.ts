...
const TREE_KO: Record<string, { name: string; description: string }> = {
  ...
  static_charge: { name: '정전기 충전', description: '스위프 감전 피해 +0.35' },
  static_link: { name: '정전 링크', description: '스위프 감전에 전체 터렛 DPS의 +4%가 피해로 추가' },
  heat_sink: { name: '히트 싱크', description: '스위프 히트 +30, 히트 재생 +15%' },
